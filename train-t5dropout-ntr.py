...
from models_t5dropout import T5DropoutForNTR
...
def main():
    ...
    model = T5DropoutForNTR.from_pretrained(
    ...
    dev_ntr = load_dataset('text', data_files={'data/canard/dev.ntr.seq2seq.tsv'})['train']
